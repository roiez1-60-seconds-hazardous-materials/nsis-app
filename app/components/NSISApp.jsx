...
const content = {
  he: {
      ...
      steps: [
        {
          phase: "שלב 1 — התראה",
          time: "T+0 דקות",
          title: "קבלת דיווח על אירוע",
          desc: "צוות כב\"ה מקבל דיווח על אבקה חשודה שנמצאה בחבילה בבניין ציבורי. הצוות מגיע לזירה עם ציוד CBRN מלא.",
          status: "alert"
        },
        {
          phase: "שלב 2 — דגימה",
          time: "T+15 דקות",
          title: "איסוף וקליטת דגימה",
          desc: "נלקחת דגימה מהחומר החשוד. הדגימה מוכנסת לערכת ריצוף מהירה ומוטענת למכשיר MinION שנמצא בניידת CBRN.",
          status: "sampling"
        },
        {
          phase: "שלב 3 — ריצוף",
          time: "T+20 דקות",
          title: "ריצוף בזמן אמת",
          desc: "מכשיר MinION מתחיל לרצף את ה-DNA. הנתונים נשלחים בזמן אמת למערכת הביואינפורמטיקה EDGE לניתוח.",
          status: "sequencing"
        },
        {
          phase: "שלב 4 — זיהוי",
          time: "T+35 דקות",
          title: "קבלת תוצאות זיהוי",
          desc: "המערכת מזהה את הסוכן הביולוגי — אפילו אם מדובר בזן חדש או מהונדס שלא קיים בשום מאגר ידוע. ההתראה מועברת לגורמי פיקוד.",
          status: "identified"
        },
        {
          phase: "שלב 5 — תגובה",
          time: "T+40 דקות",
          title: "הפעלת פרוטוקול תגובה",
          desc: "בהתבסס על הזיהוי, מופעל פרוטוקול הטיפול המתאים. ה-DNA המלא של הסוכן זמין לניתוח פורנזי מעמיק.",
          status: "response"
        }
      ],
    ...
    bib: {
      ...
      categories: [
        {
          title: "מקורות טכניים — Oxford Nanopore Technologies",
          refs: [
            "[1] MinION Mk1C Technical Specification (2025)",
            "[2] MinION Mk1D Technical Specification (2024)",
            "[3] How Oxford Nanopore Sequencing Works (2025)",
            "[4] MinION & Flow Cells Hardware Documentation (2025)",
            "[5] MinION Mk1C IT Requirements (2025)",
            "[6] Platform Technology Overview (2025)",
            "[7] Product Specifications (2025)"
          ]
        },
        {
          title: "מאמרים אקדמיים",
          refs: [
            "[8] Jain et al. (2016) — Genome Biology, 17, 239",
            "[9] Deamer et al. (2016) — Nature Biotechnology, 34(5)",
            "[10] Kasianowicz et al. (1996) — PNAS, 93(24)",
            "[11] Au et al. (2012) — PLoS One, 7(10)",
            "[12] Wang et al. (2021) — Nature Biotechnology, 39(11)"
          ]
        },
        {
          title: "ביואינפורמטיקה ורצף גנומי",
          refs: [
            "[13] PMC — Introduction to Nanopore Sequencing (2023)",
            "[14] ScienceDirect — Nanopore Sequencing Overview (2025)",
            "[15] PMC — Nanopore Sequencing & Applications (2023)",
            "[16] PMC — Nanopore Technology in Gene Sequencing (2021)",
            "[17] ACS Nano — DNA/RNA Modification Detection (2024)",
            "[18] WhatIsBiotech — Nanopore Decoding DNA/RNA (2023)"
          ]
        },
        {
          title: "מקורות חינוכיים ומדריכים",
          refs: [
            "[19] Otago Bioinformatics — Nanopore Introduction (2023)",
            "[20] Nanopore4edu — Sequencing Hardware Guide (2024)"
          ]
        },
        {
          title: "מקורות צבא וביטחון אמריקני",
          refs: [
            "[21] U.S. DoD — JPEO-CBRND Milestone B (2025) [FOIA]",
            "[22] Johns Hopkins APL — CBRN Defense R&D (2024)",
            "[23] DTRA — EDGE Bioinformatics Platform (2024)"
          ]
        }
      ]
    },
    contact: {
      ...
      name: "רועי צוקרמן",
      role: "מומחה CBRN — כבאות והצלה לישראל",
  ...
  en: {
      ...
      steps: [
        {
          ...
          desc: "Fire & Rescue CBRN team receives a report of suspicious powder found in a package at a public building. Team deploys with full CBRN equipment.",
          status: "alert"
        },
        {
          phase: "Phase 2 — Sampling",
          time: "T+15 min",
          title: "Sample Collection",
          desc: "A sample is collected from the suspected substance, prepared with a rapid sequencing kit, and loaded into the MinION device in the CBRN response vehicle.",
          status: "sampling"
        },
        {
          ...
          desc: "The MinION begins sequencing the DNA. Data is streamed in real-time to the EDGE bioinformatics analysis platform.",
          status: "sequencing"
        },
        {
          ...
          desc: "The system identifies the biological agent — even if it's a novel or engineered strain not in any known database. Alert is forwarded to command.",
          status: "identified"
        },
        {
          phase: "Phase 5 — Response",
          time: "T+40 min",
          title: "Response Protocol Activation",
          desc: "Based on the identification, the appropriate treatment protocol is activated. Full pathogen DNA is available for deep forensic analysis.",
          status: "response"
        }
      ],
    ...
    bib: {
      ...
      categories: [
        {
          title: "Technical Sources — Oxford Nanopore Technologies",
          refs: [
            "[1] MinION Mk1C Technical Specification (2025)",
            "[2] MinION Mk1D Technical Specification (2024)",
            "[3] How Oxford Nanopore Sequencing Works (2025)",
    ...
    contact: {
      ...
      name: "Roie Zukerman",
      role: "CBRN Expert — Israel Fire and Rescue Services",
      email: "roiez1@gmail.com",
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      for (let i = 0; i < pairs; i++) {
        ...
        // Backbone spheres — draw back one first, then front
...
function CurrentSignal() {
  ...
  useEffect(() => {
    ...
    // Generate signal pattern representing ATGC bases
...
// ─────────────────────── Simulation Timeline ───────────────────────
function SimTimeline({ steps, lang, startBtn, resetBtn, runningLabel }) {
      ...
      <div style={{ display: "flex", gap: 12, marginBottom: 32, justifyContent: "center" }}>
        <button
          ...
          style={{
            ...
            transition: "all 0.3s", opacity: running ? 0.5 : 1
          }}
        >
          {running ? runningLabel : startBtn}
        </button>
        <button
          onClick={reset}
          style={{
    ...
    <div style={pageStyle}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6 }} className="nav-links">
            {Object.entries(t.nav).map(([key, label]) => (
              <button key={key} onClick={() => scrollTo(key === "home" ? "hero" : key)}
                style={{
                  background: "none", border: "none", color: "#94a3b8", fontSize: 14, fontWeight: 500,
            ...
            <button
              ...
              style={{
                ...
                color: "#00d4ff", fontSize: 13, fontWeight: 700, padding: "6px 14px", borderRadius: 8,
                cursor: "pointer", fontFamily: "'JetBrains Mono', monospace", marginInlineStart: 8
              }}
            >{t.langSwitch}</button>
          </div>
        </div>
      ...
      <section id="hero" style={{ minHeight: "100vh", display: "flex", alignItems: "center", position: "relative", paddingTop: 80 }}>
        <div style={{
          ...
          display: "flex", alignItems: "center", gap: 40, flexWrap: "wrap", justifyContent: "center"
        }}>
          <div style={{ flex: "1 1 500px", animation: "slideUp 1s ease" }}>
            ...
            <h2 style={{ fontSize: "clamp(18px, 3vw, 26px)", fontWeight: 600, color: "#cbd5e1", margin: "0 0 8px" }}>
              {t.hero.subtitle}
            </h2>
            <p style={{ color: "#64748b", fontSize: 14, fontFamily: "'JetBrains Mono', monospace", margin: "0 0 24px" }}>
              {t.hero.fullName}
            </p>

            <p style={{ color: "#94a3b8", fontSize: 16, lineHeight: 1.8, margin: "0 0 32px", maxWidth: 600 }}>
              {t.hero.desc}
            </p>
      ...
      <section id="tech" style={{ position: "relative" }}>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{
            ...
            border: "1px solid rgba(0,212,255,0.12)", padding: 32, marginBottom: 40,
            ...
            <div style={{ display: "flex", gap: 32, flexWrap: "wrap", alignItems: "center" }}>
              ...
              <div style={{ flex: "0 1 300px", display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
                {t.tech.nanopore.specs.map((s, i) => (
                  <div key={i} style={{
                    background: "rgba(0,212,255,0.08)", borderRadius: 16, padding: "16px 20px",
                    border: "1px solid rgba(0,212,255,0.15)", textAlign: "center", minWidth: 120, flex: "1 1 120px"
                  }}>
          ...
          <div style={{
            background: "rgba(255,255,255,0.02)", borderRadius: 20, padding: "24px 24px 16px",
            border: "1px solid rgba(255,255,255,0.06)", marginBottom: 40, textAlign: "center"
          }}>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: 16, marginTop: 8, flexWrap: "wrap" }}>
              {[
                { base: "A", color: "#00d4ff", name: "Adenine" },
                { base: "T", color: "#ff6b9d", name: "Thymine" },
                { base: "G", color: "#10b981", name: "Guanine" },
                { base: "C", color: "#f59e0b", name: "Cytosine" }
              ].map(b => (
                <span key={b.base} style={{ fontSize: 12, color: b.color, fontFamily: "'JetBrains Mono', monospace", fontWeight: 600 }}>
                  {b.base} — {b.name}
                </span>
              ))}
            </div>
            ...
            {t.tech.process.steps.map((step, i) => (
              ...
              >
                <div style={{
                  ...
                  color: "#00d4ff", fontSize: 12, fontWeight: 800, fontFamily: "'JetBrains Mono', monospace"
                }}>{i + 1}</div>
          ...
          <div style={{
            ...
            borderRadius: 24, padding: 32, border: "1px solid rgba(124,58,237,0.15)"
          }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: 12 }}>
              {t.tech.minion.specs.map((s, i) => (
                <div key={i} style={{
                  background: "rgba(0,0,0,0.2)", borderRadius: 14, padding: "14px 16px",
      ...
      <section id="sim" style={{ position: "relative" }}>
        ...
        <div style={sectionStyle}>
          ...
          <SimTimeline
            steps={t.sim.steps}
            lang={lang}
            startBtn={t.sim.startBtn}
            resetBtn={t.sim.resetBtn}
      ...
      <section id="pros" style={{ position: "relative" }}>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(400px, 1fr))", gap: 24 }}>
            {/* Advantages */}
            <div style={{
              background: "rgba(16,185,129,0.04)", borderRadius: 24, padding: 28,
            ...
            {/* Limitations */}
            <div style={{
              background: "rgba(245,158,11,0.04)", borderRadius: 24, padding: 28,
      ...
      <section id="bib" style={{ position: "relative" }}>
        ...
        <div style={sectionStyle}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            {t.bib.categories.map((cat, i) => (
              <details key={i} style={{
                background: "rgba(255,255,255,0.03)", borderRadius: 16,
                border: "1px solid rgba(255,255,255,0.06)", overflow: "hidden"
              }}>
                <summary style={{
                  padding: "16px 24px", cursor: "pointer", color: "#e2e8f0",
                  fontSize: 16, fontWeight: 600, listStyle: "none",
                  ...
                  <span style={{
                    ...
                    background: "rgba(0,212,255,0.1)", color: "#00d4ff", flexShrink: 0,
                ...
                <div style={{ padding: "0 24px 16px" }}>
                  {cat.refs.map((ref, j) => (
                    <div key={j} style={{
                      padding: "8px 0", borderTop: j > 0 ? "1px solid rgba(255,255,255,0.04)" : "none",
                      color: "#94a3b8", fontSize: 13, lineHeight: 1.5, fontFamily: "'JetBrains Mono', monospace"
                    }}>{ref}</div>
                  ))}
                </div>
              </details>
      ...
      <section id="contact" style={{ position: "relative" }}>
        ...
        <div style={{ ...sectionStyle, textAlign: "center" }}>
          ...
          <div style={{
            ...
            border: "1px solid rgba(255,255,255,0.08)", maxWidth: 600, margin: "0 auto 24px",
            backdropFilter: "blur(10px)"
          }}>
            {/* 60 seconds logo */}
            <div style={{
              ...
              fontSize: 14, fontWeight: 900, color: "#fff", textAlign: "center", lineHeight: 1.2
            }}>
              <span>60<br /><span style={{ fontSize: 9, fontWeight: 600 }}>שניות</span></span>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12, alignItems: "center" }}>
              <a href="mailto:roiez1@gmail.com" style={{
                color: "#00d4ff", textDecoration: "none", fontSize: 15,
