...
const content = {
  he: {
    ...
    hero: {
      ...
      desc: "מערכת זיהוי ביולוגי מהפכנית המבוססת על טכנולוגיית רצף ננונקבים (Nanopore Sequencing), שפותחה על ידי משרד הביטחון האמריקני. מאפשרת זיהוי של גורמים ביולוגיים ואיומים חדשים — גם ללא מידע מוקדם על החומר/מחולל.",
    ...
    sim: {
      ...
      steps: [
        ...
        { phase: "שלב 4 — זיהוי", time: "T+35 דקות", title: "קבלת תוצאות זיהוי", desc: "המערכת מזהה את החומר/מחולל הביולוגי — אפילו אם מדובר בזן חדש או מהונדס שלא קיים בשום מאגר ידוע. ההתראה מועברת לגורמי פיקוד.", status: "identified" },
        { phase: "שלב 5 — תגובה", time: "T+40 דקות", title: "הפעלת פרוטוקול תגובה", desc: "בהתבסס על הזיהוי, מופעל פרוטוקול הטיפול המתאים. ה-DNA המלא של החומר/מחולל זמין לניתוח פורנזי מעמיק.", status: "response" }
      ],
    ...
    pros: {
      ...
      advantages: {
        title: "יתרונות",
        items: [
          { icon: "🔍", title: "זיהוי ללא ידע מוקדם", desc: "יכולת מהפכנית לזהות איומים ביולוגיים חדשים ובלתי מוכרים ללא צורך במידע קודם על החומר/מחולל" },
